...
public class MainActivity extends AppCompatActivity{
    ...
    public void callForusSdk() {
        ...
        ForusFaceConfig forusFaceConfig = new ForusFaceConfig.Builder()
                ...
                .setTimestampOnFace(Color.RED, 14.0f, "hh:mm aaa") // Sets the timestamp watermark on the output image
...
| *setTimestampOnFace(int timestampColor, float timestampSize, String timestampFormat)*      | true                | Optional      | Sets the timestamp watermark on the output image. |
